...
function applySuper () {
    var firstCaller = applySuper.caller,    
        firstArgs = arguments.length ? arguments : firstCaller.arguments;
    
    function _super () {
        var caller = _super.caller,
            args = arguments.length ? (firstArgs = arguments) : firstArgs,
            callerUp, fn;
        ...
        if (!caller._super) {
            linkSuperChain(this, getKeyForCaller(this, caller));
        }

        fn = caller._super;
        return fn && fn.apply(this, args || caller.arguments);
    }
