...
LinkedList = utils.classify({
    ...
    makeItem: function (data, prev, next) {
        return new Item(data, prev, next);
    },
    /**
    ...
    insert: function (idx, data) {
        this.getCursor().moveTo(idx).insert(this.makeItem(data));
        return this;
    },
    
    insertBefore: function (idx, data) {
        this.getCursor().moveTo(idx).insertBefore(this.makeItem(data));
        return this;
    },
    ...
    push: function () {
        ...
        if (arglen > 1) {
            ...
            this.tail = this.makeItem(arguments[0], this.tail, null);
            if (!this.head) {
                this.head = this.tail;
            }
            this.length++;
    ...
    unshift: function () {
        ...
        if (arglen > 1) {
            ...
            this.head = this.makeItem(arguments[0], null, this.head);
            if (!this.tail) {
                this.tail = this.head;
            }
            this.length++;
